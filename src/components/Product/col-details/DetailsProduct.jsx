    ...
    return (
        <section className='container mx-auto px-4 md:px-0'>
            ...
            <div className='mb-5 grid grid-cols-3 items-center gap-4 font-bold md:grid-cols-[1fr_3fr] md:gap-1'>
                ...
                <span className='mr-auto bg-pale-orange px-2 py-1 text-orange-primary'>
                    50%
                </span>
                <span className='text-left text-lg text-grayish-blue line-through md:col-span-2'>
                    $250.00
                </span>
            </div>
            <div className='grid grid-cols-3 gap-4 font-bold md:grid-cols-[1fr_1.7fr]'>
                ...
                <button className='col-span-3 flex items-center justify-center gap-x-4 rounded-md bg-orange-primary py-3 text-white transition-all hover:bg-orange-700 md:col-span-1'>
                    <CartIcon fill='#fff' />
